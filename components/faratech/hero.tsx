...
export function Hero() {
  ...
  return (
    <section className="relative bg-[var(--brand-navy)] text-white overflow-hidden min-h-[92vh] flex flex-col">
      ...
      {/* Corner registration marks — precision engineering motif */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[70vh]">
          ...
          <div className={`space-y-8 ${mounted ? 'animate-fade-up' : 'opacity-0'}`}>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs tracking-[0.25em] uppercase text-white/60 font-medium">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.0] tracking-tight text-balance">
              ...
              <br />
              <span className="text-[var(--brand-red)]">Mobility.</span>
            </h1>

            {/* Sub */}
            <p className="text-lg text-white/65 leading-relaxed max-w-md">
              FARATECH engineers premium wheelchair systems where aerospace precision meets
              clinical expertise — trusted by 1,200+ healthcare institutions across 60 countries.
            </p>
            ...
            <div className="flex items-center gap-6 pt-2">
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-white">35+</div>
                <div className="text-xs text-white/50 mt-1 tracking-wide uppercase">Years</div>
              </div>
              <div className="w-px h-10 bg-white/15" />
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-white">60+</div>
                <div className="text-xs text-white/50 mt-1 tracking-wide uppercase">Countries</div>
              </div>
              <div className="w-px h-10 bg-white/15" />
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-white">1,200+</div>
                <div className="text-xs text-white/50 mt-1 tracking-wide uppercase">Partners</div>
              </div>
              <div className="w-px h-10 bg-white/15" />
              <div className="text-center">
                <div className="font-heading text-3xl font-bold text-white">98%</div>
                <div className="text-xs text-white/50 mt-1 tracking-wide uppercase">Satisfaction</div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative w-full max-w-lg aspect-square">
              <Image
                src="/images/hero-wheelchair.png"
                alt="FARATECH ActivePro X1 — Premium Ultralight Wheelchair"
                fill
                priority
              ...
              <div className="absolute top-8 -left-4 bg-white text-[var(--brand-navy)] px-3 py-2 rounded-lg shadow-lg text-xs font-semibold">
                ...
                <div className="text-muted-foreground font-normal">Total Frame Weight</div>
              </div>
              ...
              <div className="absolute bottom-16 -right-4 bg-white text-[var(--brand-navy)] px-3 py-2 rounded-lg shadow-lg text-xs font-semibold">
                ...
                <div className="text-muted-foreground font-normal">Carbon Fiber Grade</div>
              </div>

              <div className="absolute top-1/2 -right-6 bg-[var(--brand-red)] text-white px-3 py-2 rounded-lg shadow-lg text-xs font-bold">
                NEW 2025
              </div>
            </div>
          </div>
